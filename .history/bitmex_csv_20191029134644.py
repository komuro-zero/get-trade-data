...
#price = bitmex_api.Trade.Trade_get(symbol="XBTUSD", reverse=True, count = count).result()
#start_time = now - timedelta(days = 7)
start_time = datetime.strptime("2019-10-11 05:01:36",'%Y-%m-%d %H:%M:%S')
print(start_time)
...
#2019-09-09 06:28:36.886000+00:00